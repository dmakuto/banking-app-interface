...
document.querySelector('.nav__links').addEventListener('click', function (e) {
  ...
  console.log(e.currentTarget); //<ul class="nav__links">...</ul>
...
/*
  - mouseover bubbles unlike mouseenter.
  - mouseover is the opposite of mouseout.
  - mouseenter is the opposite of mouseleave.
*/

const handleHover = function (e) {
  // console.log(this, e.currentTarget); --> 0.5 nav, 1 nav
...
const headerObserver = new IntersectionObserver(stickyNav, stickyOps);
...
const sectionObserver = new IntersectionObserver(revealSection, objOpScroll);
...
const imgObserver = new IntersectionObserver(loadImg, objOpLoad);
...
const goToSlide = function (slide) {
  slides.forEach(
    ...
    // slide = 1; i= 0; --> -100%, 0%, 100%, 200%, 300%
    // slide = 1, i= 1; --> 0%, 100%, 200%, 300%
    // slide = 1; i= 2; --> 100%, 200%, 300%, 0%, -100%
  );
};
goToSlide(0);
